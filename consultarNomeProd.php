        ...
        <div class="row">
          <?php
            ...
            if (!empty($nome)) {
              ...
              $stmt = $pdo->prepare("SELECT ID_PRODUTOS, NOME, COD_PRODUTO, PRECO, QUANTIDADE, DATA_VALIDADE, COD_BARRAS, LOCAL_ARMAZENADO, DESCRICAO, USUARIO, DATA_CADASTRO FROM PRODUTOS WHERE NOME LIKE :NOME ORDER BY NOME");
