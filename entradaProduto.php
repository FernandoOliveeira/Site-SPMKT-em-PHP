      ...
      <div class="container">
        <fieldset>
          <div class="bg-info rounded box form-group text-center m-2 p-2">
            <legend class="text-white display-4 my-3"><i class="fas fa-boxes"></i>&nbspEntrada de Produtos</legend>
            ...
            <form action="controller/verificaEntradaProduto.php" method="POST" class="text-center m-2 p-2">
